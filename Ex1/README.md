...
WebService can be found at ```Ex1/WeService``` folder. The Service is written with NodeJs and MongoDb.
### Instruction
1. Install node, mongodb
2. At the directory, run npm install at first
3. Run mongod to run your MongoDb Service
4. Move to WebService folder. Run ```nodemon server.js```
5. Open your browser, access the api to get result. Sample query url ```http://localhost:3000/lat=10&long=11&lat=69&long=12```
6. Enjoy the result

If you have any problem with the service, pls contact me at ```phuchuynh.strong@gmail.com```
